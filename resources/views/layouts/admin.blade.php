...
<head>
    ...
    <link href="{{ asset('backend/dist/css/bootstrapicons-iconpicker.css') }}" rel="stylesheet">
    @yield('styles')
</head>
<!-- END: Head -->
<body class="py-5 md:py-0">
@include('admin.sections.mobileMenu')
...
<script src="{{ asset('backend/dist/js/bootstrapicon-iconpicker.js') }}"></script>
<script>
